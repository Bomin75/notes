...
- Selection factors:
  - A parasitic wasp, _Eurytoma gigantea_, use hormone to find the gall and inject their eggs -> hatches, eats the larvae, steals the protection
    ![LarvaeParasitizedVsGallSize](./Fly_Larvae_Parasitized_vs_Gall_Size.png)
  ...
  - A downy woodpecker, _Picoides pubescens_, is also a predator of the golden gall larvae
    ![LarvaeEatenVsGallSize](./Fly_Larvae_Eaten_vs_Gall_Size.png)
...
- Comparative **morphology** revealed structural similarities in dissimilar anatomies
  ![Similarity_in_Dissimiliar_Anatomies](./Similarity_in_Dissimilar_Anatomies.png)
...
![Beak_Depth_Variation](./Beak_Depth_Variation.png)
...
<a id="paternity"></a>**paternity**: a state of being someone's father
